...
```json
"com.kpk.codex-unity-link": "https://github.com/kpkhxlgy0/unity-links-unity.git#v0.2.3"
```
...
Component version `0.2.3` is tested with `unity-links-codex` version `0.2.2`. The package contains only Editor code and
